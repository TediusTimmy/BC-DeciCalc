...
g++ -c -Wall -Wextra -Wpedantic -g --coverage -O0 Fixed.cpp IntegerBN.cpp
g++ -o Test -Wall -Wextra -Wpedantic -g --coverage -O0 -I../../External/googletest/include Test.cpp Fixed.o IntegerBN.o ../../External/googletest/lib/libgtest.a ../../External/googletest/lib/libgtest_main.a -lcrypto
